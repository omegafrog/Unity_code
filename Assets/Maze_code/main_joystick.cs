...
public class main_joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    ...
    void Start()
    {
        m_rectBack = transform.Find("joystick").GetComponent<RectTransform>();
        m_rectJoystick = transform.Find("joystick/lever").GetComponent<RectTransform>();

        m_trCube = GameObject.Find("main_CT").transform;
